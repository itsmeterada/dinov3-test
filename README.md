...
- **画像削除**: 検索結果から不要な画像をデータベースから削除
- **フォルダ/ZIP処理**: 画像の一括登録
- **美しいGUI**: PyQt6でモダンなUI
- **ドラッグ&ドロップ**: 簡単な操作性
- **多様な画像形式**: JPEG, PNG, BMP, GIF, WebP, AVIF, TIFF, JFIFに対応
...
3. 類似度（0-100%）で色分け表示
4. 検索結果の画像右下の「🗑️ DBから削除」ボタンで不要な画像を削除可能
